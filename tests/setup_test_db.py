...
def setup_test_database():
    ...
    try:
        ...
        print("Database setup completed successfully with migrations")
        ...
        try:
            ...
            print("Database setup completed with alternative migration")
        except Exception as e2:
            print(f"Alternative migration also failed: {e2}")
            print("Creating minimal database structure manually...")
            
            # Last resort: create tables manually
            try:
                ...
                print(f"Manual table creation also failed: {e3}")
                print("Tests may fail due to missing database tables")
